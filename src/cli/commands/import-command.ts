...
import { DefaultOfferService } from '#src/shared/modules/offer/default-offer-service.js';
import { OfferModel } from '#src/shared/modules/offer/offer-entity.js';
import { OfferService } from '#src/shared/modules/offer/offer-service.interface.js';
import { DefaultUserService } from '#src/shared/modules/user/default-user-service.js';
import { UserModel } from '#src/shared/modules/user/user-entity.js';
import { UserService } from '#src/shared/modules/user/user-service.interface.js';
